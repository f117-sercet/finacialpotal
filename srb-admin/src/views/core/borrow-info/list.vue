...
<div class="app-container">
  ...
  <el-table :data="list" stripe>
    ...
    <el-table-column prop="param.moneyUse" label="资金用途" width="100"></el-table-column>
    <el-table-column label="年化利率" width="90">
       <template slot-scope="scope">
         {{scope.row.borroweYearRate *100}}%
       </template>
    </el-table-column>
    <el-table-column prop="param.status" label="状态" width="100"/>
    <el-table-colum prop="createTime" label="申请时间" width="150"/>
    <el-table-colum label="操作" width="150" align="center">
      <template slot-scope="scope">
