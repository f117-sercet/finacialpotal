...
export default{
    ...
    method:{
        fetchDataById(){
            lendApi.show(this.$route.param.id).then(reponse=>{
                this.lendDetail = reponse.data.lendDetail
            })
        },
        back(){
        ...
        fetchLendItemList(){
            lendItemApi.getList(this.$route.param.id).then(resonse=>{
                this.lendItemList = resonse.data.list
            })
        },
        fetchLendReturnList(){
            lendReturnApi.getList(this.$route.param.id).then(response=>{
